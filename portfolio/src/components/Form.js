      ...
      <Text h3>Send a Quick Message</Text>
        <form className={styles.form} onSubmit={handleFormSubmit}>
          ...
          <Input 
            ...
            aria-label='email'
          />
          <Textarea className={styles.textarea} required htmlFor="message" id="message" minrows={2} underlined placeholder="body of your message here" aria-label='input-text' />
