...
import { Container, Text, Col, Row, Card, Button, Spacer, Tooltip } from '@nextui-org/react';
...
import headshot from '../../public/assets/images/patrick.jpg';
      ...
      <Col>
        ...
        <Row id="row-with-stuff">
          <Card id="headshotcard" cover>
              ...
              <Card.Body>
                <Image src={headshot} height={800} width={800} objectFit="cover"></Image>
              </Card.Body>
              <Card.Footer
                blur
                css={{
                ...
                <Row>
                  <Col>
                    <Row justify="space-evenly">
                      <Tooltip placement="leftStart" content="Visit Github" color="primary" >
                      ...
                      <Tooltip placement="top" content="Email Me" color="primary" >
                      ...
                      <Tooltip placement="rightStart" content="See me on Twitter" color="primary" >
                    ...
                    <Spacer y={0.75} />
                    <Row justify="space-evenly">
                      <Tooltip placement="leftEnd" content="See me on LinkedIn" color="primary" >
                      ...
                      <Tooltip placement="bottom" content="See me on Facebook" color="primary" >
